                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php/id=<?php echo $row["Id"] ?>"><i class="fa-solid fa-square-pen">edit</i></a>
                                                <a href="del-internship.php?id=<?php echo $row["Id"] ?>" class="ms-4"><i class="fa-solid fa-trash">delete</i></a>
                                            </td>
                                        </tr>
